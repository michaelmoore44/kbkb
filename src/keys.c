...
sub_keys_t sub_keys[NUM_SUB_KEYS] = {
    ...
    [KEY_A3S] = {BEHAVIOR_NORM, KC_ENTER,  KC_NO},
    ...
    [KEY_C2S] = {BEHAVIOR_NORM, KC_Q,      KC_PGUP},
    [KEY_C3S] = {BEHAVIOR_NORM, KC_A,      KC_LEFT},
    [KEY_C4S] = {BEHAVIOR_NORM, KC_Z,      KC_PGDOWN},
    [KEY_D1S] = {BEHAVIOR_NORM, KC_2,      KC_F2},
    [KEY_D2S] = {BEHAVIOR_NORM, KC_W,      KC_HOME},
    [KEY_D3S] = {BEHAVIOR_NORM, KC_S,      KC_DOWN},
    [KEY_D4S] = {BEHAVIOR_NORM, KC_X,      KC_NO},
    [KEY_D5S] = {BEHAVIOR_NORM, KC_BSPACE, KC_NO},
    [KEY_E1S] = {BEHAVIOR_NORM, KC_3,      KC_F3},
    [KEY_E2S] = {BEHAVIOR_NORM, KC_E,      KC_NO},
    [KEY_E3S] = {BEHAVIOR_NORM, KC_D,      KC_UP},
    [KEY_E4S] = {BEHAVIOR_NORM, KC_C,      KC_NO},
    [KEY_E5S] = {BEHAVIOR_NORM, KC_DELETE, KC_NO},
    [KEY_F1S] = {BEHAVIOR_NORM, KC_4,      KC_F4},
    [KEY_F2S] = {BEHAVIOR_NORM, KC_R,      KC_END},
    [KEY_F3S] = {BEHAVIOR_NORM, KC_F,      KC_RIGHT},
    [KEY_F4S] = {BEHAVIOR_NORM, KC_V,      KC_NO},
    [KEY_F5S] = {BEHAVIOR_NORM, KC_SPACE,  KC_NO},
    ...
    [KEY_G5S] = {BEHAVIOR_MOD,  MOD_LCTL,  KC_NO},
