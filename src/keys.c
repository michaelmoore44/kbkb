...
sub_keys_t sub_keys[NUM_SUB_KEYS] = {
    [KEY_A1S] = {BEHAVIOR_NORM, KC_EQUAL},
    [KEY_A2S] = {BEHAVIOR_NORM, KC_RBRACKET},
    [KEY_A3S] = {BEHAVIOR_NORM, KC_ENTER},
    [KEY_B1S] = {BEHAVIOR_NORM, KC_MINUS},
    [KEY_B2S] = {BEHAVIOR_NORM, KC_LBRACKET},
    [KEY_B3S] = {BEHAVIOR_NORM, KC_QUOTE},
    [KEY_B4S] = {BEHAVIOR_NORM, KC_BSLASH},
    [KEY_C1S] = {BEHAVIOR_NORM, KC_0},
    [KEY_C2S] = {BEHAVIOR_NORM, KC_P},
    [KEY_C3S] = {BEHAVIOR_NORM, KC_SCOLON},
    [KEY_C4S] = {BEHAVIOR_NORM, KC_SLASH},
    [KEY_D1S] = {BEHAVIOR_NORM, KC_9},
    [KEY_D2S] = {BEHAVIOR_NORM, KC_O},
    [KEY_D3S] = {BEHAVIOR_NORM, KC_L},
    [KEY_D4S] = {BEHAVIOR_NORM, KC_DOT},
    [KEY_D5S] = {BEHAVIOR_NORM, KC_BSPACE},
    [KEY_E1S] = {BEHAVIOR_NORM, KC_8},
    [KEY_E2S] = {BEHAVIOR_NORM, KC_I},
    [KEY_E3S] = {BEHAVIOR_NORM, KC_K},
    [KEY_E4S] = {BEHAVIOR_NORM, KC_COMMA},
    [KEY_E5S] = {BEHAVIOR_NORM, KC_DELETE},
    [KEY_F1S] = {BEHAVIOR_NORM, KC_7},
    [KEY_F2S] = {BEHAVIOR_NORM, KC_U},
    [KEY_F3S] = {BEHAVIOR_NORM, KC_J},
    [KEY_F4S] = {BEHAVIOR_NORM, KC_M},
    [KEY_F5S] = {BEHAVIOR_NORM, KC_SPACE},
    [KEY_G1S] = {BEHAVIOR_NORM, KC_6},
    [KEY_G2S] = {BEHAVIOR_NORM, KC_Y},
    [KEY_G3S] = {BEHAVIOR_NORM, KC_H},
    [KEY_G4S] = {BEHAVIOR_NORM, KC_N},
    [KEY_G5S] = {BEHAVIOR_NORM, KC_NO},
    [KEY_H1S] = {BEHAVIOR_NORM, KC_NO},
    [KEY_H2S] = {BEHAVIOR_NORM, KC_NO},
    [KEY_H3S] = {BEHAVIOR_NORM, KC_NO},
    [KEY_H4S] = {BEHAVIOR_MOD,  MOD_RSH},
    [KEY_I1S] = {BEHAVIOR_MOD,  MOD_RCTL},
    [KEY_J1S] = {BEHAVIOR_NORM, KC_NO},
};
